...
export default class PlanePosConfig {
    ...
    public static planesOriginPos = [
        [
            new cc.Vec2(-475,-210),new cc.Vec2(-345,-210),new cc.Vec2(-475,-348),new cc.Vec2(-345,-348)
        ],
        [
            new cc.Vec2(-480,670),new cc.Vec2(-350,670),new cc.Vec2(-480,530),new cc.Vec2(-349,530)
        ],
        [
            new cc.Vec2(350,675),new cc.Vec2(480,675),new cc.Vec2(350,535),new cc.Vec2(480,535)
        ],
        [
            new cc.Vec2(350,-213),new cc.Vec2(480,-213),new cc.Vec2(350,-353),new cc.Vec2(480,-353)
        ]
    ]
